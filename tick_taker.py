...
def hello():
    ...
    parser.add_argument(
        'PKSAWVRI13BK1YFG5JT9', type=str, default=None,
        help='API key ID',
    )
    parser.add_argument(
        'EUGoVcLwnE1n5Ro7l1Z9MNASbPuLFiOBX6XJKOy4', type=str, default=None,
        help='API secret key',
    )
    parser.add_argument(
        ' https://paper-api.alpaca.markets', type=str, default=None,
